            ...
            <div className="page-container">
                ...
                <div className="category-header animate-in">
                    ...
                    <p className="category-header-count">
                        {subcategory.skills.length} toolbox{subcategory.skills.length !== 1 ? 'es' : ''}
                    </p>
                </div>
    ...
    return (
        <div className="page-container">
            ...
            <div className="category-header animate-in">
                ...
                <h1>{category.name}</h1>
                <p className="category-header-count">
                    {totalSkills} toolbox{totalSkills !== 1 ? 'es' : ''}
                    ...
                    {category.subcategories.map((sc, i) => (
                        ...
                        >
                            ...
                            <div className="category-card-count">
                                {sc.skills.length} toolbox{sc.skills.length !== 1 ? 'es' : ''}
                            </div>
            ...
            {category.skills.length > 0 && (
                <section className="animate-in animate-in-delay-2">
                    {category.subcategories.length > 0 && (
                        <h2 className="subcategory-title">General Toolboxes</h2>
                    )}
